      ...
      >
        ...
        <div className="border-t border-surface-border px-5 py-4">
          {isSuperAdmin ? (
            ...
            <div className="flex items-center justify-between gap-3">
              {/* Identity — links to public profile page */}
              <Link href={`/p/${username}`} className="flex items-center gap-2.5 min-w-0 group">
                ...
                <div className="min-w-0">
                  <p className="text-sm font-medium text-white truncate group-hover:text-brand-300 transition-colors">{fullName}</p>
