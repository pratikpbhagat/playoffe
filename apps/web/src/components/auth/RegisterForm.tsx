      ...
      <Field
        ...
        hint={
          usernameStatus === 'available'
            ...
            ? 'Checking...'
            : 'Your public profile URL: platform.com/p/your-username'
        }
        hintColor={
...
function Field({
  ...
  const hintColors = { gray: 'text-gray-500', green: 'text-green-600', red: 'text-red-600' };
  return (
    <div>
...
function inputClass(hasError: boolean) {
  return `block w-full rounded-lg border px-3 py-2 text-sm shadow-sm outline-none transition focus:ring-2 focus:ring-brand-500 ${
    hasError
